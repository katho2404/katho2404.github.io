    ...
    <div class="bg-slate-300 dark:bg-slate-800 rounded-lg">
      <button
        class={`p-5 rounded-lg text-left space-y-2 hover:bg-slate-400 dark:hover:bg-slate-700 ${
          isOpen ? "border-b-4 border-palette4 rounded-b-lg bg-slate-400 dark:bg-slate-700" : ""
        }`}
            ...
            >
              <a
                ...
                class={`space-x-2 font-medium ${
                  !post.data.planned
                    ? "underline underline-offset-2 text-black dark:text-white decoration-palette4"
                    : "text-white0"
                }`}
              >
